		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				ImportStateVerifyIgnore: []string{
					...
					"forwarding_profile_actions.1.is_same_as_on_trusted_network",
					"forwarding_profile_actions.2.is_same_as_on_trusted_network",
					"forwarding_profile_actions.3.is_same_as_on_trusted_network",
					"forwarding_profile_zpa_actions.1.is_same_as_on_trusted_network",
					"forwarding_profile_zpa_actions.2.is_same_as_on_trusted_network",
					"forwarding_profile_zpa_actions.3.is_same_as_on_trusted_network",
					"unified_tunnel.1.system_proxy_data.proxy_action",
				},
			},
			{
...
func testAccForwardingProfileConfig(name string) string {
	return forwardingProfileResourceBlock(name)
}
...
func forwardingProfileResourceBlock(name string) string {
	return fmt.Sprintf(`
provider "zcc" {}
