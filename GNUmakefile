...
build13: DESTINATION=$(APPDATA)/terraform.d/plugins/$(ZCC_PROVIDER_NAMESPACE)/0.1.1/$(GOOS)_$(GOARCH)
else
build13: DESTINATION=$(HOME)/.terraform.d/plugins/$(ZCC_PROVIDER_NAMESPACE)/0.1.1/$(GOOS)_$(GOARCH)
endif
build13: fmtcheck
	@echo "==> Installing plugin to $(DESTINATION)"
	@mkdir -p $(DESTINATION)
	go build -o $(DESTINATION)/terraform-provider-zcc_v0.1.1
